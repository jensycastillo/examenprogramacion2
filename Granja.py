...
while not salir:
    ...
    if(accion ==1):
        ...
        if(tipoanimal==1):
            ...
            cantidadreproduccion=int(input("Ingrese la cantidad de animales por parto"))
        ...
        if(tipoanimal==1):
            if(conejoconstruido!=False):
                cantidadanimalespregnados=int(input("Ingrese la cantidad de animales pregnados"))
                cantidadreproduccion=int(input("Ingrese la cantidad de animales por parto"))
            ...
            if(elefanteconstruido!=False):
                cantidadanimalespreniados = int(input("Ingrese la cantidad de animales preniados"))
                cantidadreproduccion=int(input("Ingrese la cantidad de animales por parto"))
        ...
        if(tipoanimal==1):
            if(conejoconstruido!=False):
                ...
                print("No tiene conejos em su granja")
        elif(tipoanimal==2):
            if(elefanteconstruido!=False):
        ...
        print("El comandoingresado no se reconoce")
